...
print("Full Schedule (sorted by earliest to latest datetime)")
...
print("Full Schedule (filtered by pet name)")
...
print("Full Schedule (filtered by completion status - after marking a daily task complete)")
...
print("Full Schedule (sorted by earliest to latest datetime) - after resetting completed daily task to pending")
sorted_schedule = first_owner.scheduler.sort_by_time(first_owner.pets)
first_owner.scheduler.print_schedule(first_owner.pets, sorted_schedule)