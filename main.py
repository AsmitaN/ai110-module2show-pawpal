...
tank_cleaning = pawpal_system.Task("Clean tank", 5, "Weekly", "high", "11:00")
...
print("Today's Schedule (sorted by earliest to latest hour) - after resetting completed daily task to pending")
sorted_schedule = first_owner.scheduler.sort_by_time(first_owner.pets)
#for pet in first_owner.pets:
#    print(pet.get_info())
#    for task in sorted_schedule:
